...
<body>
    ...
    <header class="container-fluid cabecalho"></header>
        ...
        <nav  class="nav nav-dos-botoes-entrar-cadastrar">
            @auth
                <div class="container mt-2" id="div_auth">
                  
                    <a href="/perfil" class="text-decoration-none text-light"><small>Perfil</small>&nbsp<i class="bi bi-person-fill"></i></a>
                    &nbsp
                    <span class="text-light border"></span>
                    &nbsp
                    <a href="/logout" class="text-decoration-none text-light"><small>Sair</small>&nbsp<i class="bi bi-box-arrow-left"></i></a>
            ...
            @guest
                <div class="container mt-2" id="div_bemvindo">
                    ...
                    {{-- <span class="text-light border"></span>
                    &nbsp
                    <a href="/cadastro" class="text-decoration-none text-light"><small>Cadastrar</small>  <i class="bi bi-person-plus">  </i></a> --}}
                </div>
            @endguest
        </nav>
